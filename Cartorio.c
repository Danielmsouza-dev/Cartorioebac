...
int registro() //Função resposável  por cadstrar usários no sitema
{
...
int main()
{
	...
	for(laco=1;laco=1;)
	{
		...
		printf("Escolha a opção desjada no menu:\n\n");
		printf("\t1 - Registrar nomes\n");
		printf("\t2 - Consultar nomes\n");
		printf("\t3 - Deletar nomes\n\n");
		printf("\t4 - Sair do sisitema!\n\n"); //fim do menu
		printf("Opção: "); 
		
		scanf("%d", &opcao); //armazenando a escolha do usuário

		system("cls"); //reposável por limpar a tela
	...
	switch(opcao) //inicio da seleção do menu
		{
			...
			case 4:
			printf("Obrigador por ultilizar o sitema!\n");
			return 0;
			break;
